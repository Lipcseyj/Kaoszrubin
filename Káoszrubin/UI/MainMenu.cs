...
public sealed class MainMenu
{
    ...
    public static void ShowHelp(Func<string?>? coopStatusProvider = null)
    {
        var source = new HelpSourceLine[]
        {
            ...
            Hotkey("HOME / END", "📜 Ugrás az eseménynapló legrégebbi / legfrissebb oldalára."),
            ...
            Hotkey("Z", "🔒 Nyitott ajtó becsukása, csukott ajtó kulcsra zárása; zárt alakzatban bármelyik partitag melletti ajtó választható."),
            ...
            Hotkey("A", "A vezér karakterlapján a 2x2-es alakzatszerkesztő megnyitása."),
            ...
            Blank(),
            Hotkey("D", "⬇️ A kijelölt tárgy ledobása."),
            Hotkey("I", "🔎 A kijelölt tárgy részletei; fegyvernél és páncélnál súly, valamint felszerelési előnézet is látható."),
            Hotkey("ENTER", "✨ A kijelölt tárgy használata."),
            Hotkey("DEL", "🚪 A kijelölt partitárs végleges kirúgása, megerősítéssel."),
            Blank(),
            Section("⚔️ CSATA", ConsoleColor.Red),
            Hotkey("SPACE", "A kijelölt, szomszédos ellenfél megtámadása."),
            Hotkey("TAB", "🎯 Váltás az elérhető célpontok között; a hátsó sor szálfegyvere az első társ lekötött ellenfelét is eléri."),
            Hotkey("NYILAK", "👣 Mozgás a saját harci körben; zárt alakzatban a vezér teljes akcióból együtt mozgat mindenkit."),
            Hotkey("H", "↩️ HÁTRA!: az első sori karakter helyet cserél a mögötte álló élő társával."),
            Blank(),
            Hotkey("J", "✨ JOBB HÁTUL KÉSZÜLJ: alakzatban utasítja a jobb hátsó pozíción lévő karaktert, hogy gyógyuljon és buffolja magát."),
            Hotkey("B", "✨ BAL HÁTUL KÉSZÜLJ: alakzatban utasítja a bal hátsó pozíción lévő karaktert, hogy gyógyuljon és buffolja magát."),
            Hotkey("P", "⏭️ PASSZ: a karakter cselekvés nélkül befejezi a saját harci körét."),
            Hotkey("R", "🏃 A vezér visszavonulást rendel el; a lekötött társak búcsútámadást kapnak."),
            Blank(),
            ...
            Hotkey("T", "✝️ Pap/Lovag: Halottűzés / Szent elűzés 2 mezőre, az első körtől, használat után 10 körrel újra."),
            Blank(),
            ...
            Text($"A megingás a következő saját akció végéig tartó harci állapot. Mindig megakadályozza a mozgást, az alakzat mozgatását, a HÁTRA! helycserét és a visszavonulást."),
            Text($"🎲 Az akció elején egyetlen dobás dönti el, hogy a megingás a támadó akciót is megszakítja-e: könnyű {StaggerRules.DisruptionChance(StaggerSeverity.Light)}%, normál {StaggerRules.DisruptionChance(StaggerSeverity.Normal)}%, súlyos {StaggerRules.DisruptionChance(StaggerSeverity.Heavy)}%."),
            Blank(),
            Text("🚫 Sikeres megszakításnál nem használható fegyveres támadás, pajzslökés, varázslás vagy halottűzés; az ellenfél támadása és aktív képessége is elvész. A passz, a fegyvercsere és az egyébként engedélyezett tárgyhasználat megmarad."),
            Text("🔨 Könnyű megingást okozhat a zúzófegyver-mester találata. A sikeres pajzslökés és szörnyerő-próba normál megingást, a helyhiány miatt meghiúsuló hátralökés súlyos megingást okoz."),
            Text("⬆️ Az ismételt megingás a függő hatást a magasabb fokozatra erősíti, de nem halmozza az időtartamot. A hatás az érintett tényleges akciója után elfogy; az esetleges extra akció már tisztán indul."),
            Text($"👁️ Jelzés: a saját karakter Állapot sorában a {CombatConditionPresentation.StaggerIcon} ikon látszik. A megingott ellenfél térképi jele és portréja sötétmagenta hátteret kap; az akció eleji napló a dobást és annak eredményét is kiírja."),
            Text($"ℹ️ Hasznos tipp: a nagy erő és a nehezebb pajzs sokat segítenek hogy kevésbé tudjanak megingatni és hogy te könnyebben megingasd az ellenfelet."),
            Blank(),
            ...
            Hotkey("NAPLÓ: F", "❌ A kijelölt aktív küldetés feladása, külön megerősítéssel."),
            Blank(),
            Text("❌ A feladott küldetés nem kap több haladást, nem teljesíthető, nem kínál gyorsutazást és nem indokol visszatérő expedíciót. A teljesített küldetések nem adhatók fel."),
            Text("📜 Elira küldetései aktívak maradnak, amíg követőként vagy partitagként veletek van, illetve amíg a fogadóban vár. Ha a három fogadólátogatás után végleg távozik, befejezetlen küldetései automatikusan feladottá válnak."),
            Text("👥 Coop játékban csak a host adhat fel közös küldetést; a vendégek a naplót olvashatják."),
            Blank(),
            Section("⚖️ TEHERBÍRÁS", ConsoleColor.Green),
            Text("Teljes teherbírás = 5 + max(6, Erő × 4) + Egészség + egész(Ügyesség / 3). Ez a teljes hordott súly viszonyszáma."),
            Text("⚔ ⚖ Harci súly: a két aktív fegyver, a viselt páncél, a tartalékfegyver és mindhárom felszerelt varázstárgy együttes súlya. A karakterlapon a harci súly és a harci teherbírás együtt látható."),
            Text("⚔️ A harci teherbírás a teljes teherbírás 75%-a. A harci terhelési fokozatot a harci súly ehhez a csökkentett értékhez viszonyítva adja a játék."),
            Text("🎒 Hordott súly: a teljes harci súly és a hátizsák teljes tartalma, minden darabot beleszámítva. A HÁTIZSÁK mellett ez a súly és a teljes teherbírás jelenik meg."),
            Blank(),
            Text("📊 Könnyű terhelés: a vonatkozó teherbírás legfeljebb 50%-a. Közepes: 50% felett, legfeljebb 80%. Nehéz: 80% felett."),
            Text("⚠️ Harci közepes terhelés: −1 kezdeményezés és −1 harci mozgás. Harci nehéz terhelés: −3 kezdeményezés és −2 harci mozgás. A karakterlapi ⚡ a dobás előtti kezdeményezési alapot mutatja."),
            Text("🎒 A teljes hordott teher ezen felüli terhelése csak a térképi mozgást lassítja. A Páncélmester tehetség a harci kezdeményezési és mozgási súlybüntetést egy-egy ponttal csökkenti, legalább nulláig."),
            Blank(),
            Section("🔨 FELSZERELÉS-TARTÓSSÁG", ConsoleColor.DarkYellow),
            Text("A fegyverek, pajzsok és páncélok maximális és aktuális tartóssága a tárgyvizsgálatban és a részletes karakterinformációban látható. A 0 maximális tartósságú különleges tárgyak elpusztíthatatlanok."),
            Text("⚔️ A fegyver sikeres használatkor 1, kritikus találatkor 2 pontot kopik. A fizikai találatot fogó páncél és pajzs ugyanennyit veszít. A sav ezeken felül 2, kritikusan 4 ponttal mar; a káosz egy véletlen felszerelést 1–3 ponttal, kritikusan kétszer ennyivel koptat."),
            Blank(),
            Text("📊 50% fölött a felszerelés ép. 26–50% között kopott, 1–25% között sérült: 0-nál a fegyver használhatatlan, a vértezet nem véd."),
            Text("🛡️ Páncélok és pajzsok esetében a kopott 75% védelmet nyújt, a sérült 50%-ot"),
            Text("⚔️ Fegyverek esetében a kopott fegyver -1 találat -1 sebzés, a sérült -2 találat -2 sebzés"),
            Blank(),
            Text("🔎 A talált felszerelés 25–100% közötti véletlen állapotban kerül elő, de nem lehet eleve törött. A kereskedő a megmaradt tartóssággal arányosan kevesebbet fizet érte."),
            Text("🔨 A Javítókészlet a Kereskedőnél, a Kovácsmesternél és a Páncélmívesnél kapható. Egy készlet egy tárgyon 50 tartósságot állít helyre, de terepen legfeljebb 75%-ig javíthat. A készletet kijelölve az Enter a legrosszabb állapotú javítható felszerelést választja; egy sérült felszerelést kijelölve az Enter célzottan azt javítja."),
            Text("🏚️ A fogadói Kovácsmester a fegyvereket és pajzsokat, a Páncélmíves a vértezeteket teljesen megjavítja. A díj a hiányzó tartósságtól és a ritkaságtól függ. A +1/+2/+3 fejlesztés +15/+30/+50% maximális tartósságot ad."),
            Blank(),
            Text("🛠️ A Fegyvermester minden fegyverkopást 50%-al, a Páncélmester minden páncél- és pajzskopást 50%-al csökkent."),
            Blank(),
            Section("🔮 VARÁZSTÁRGY-AZONOSÍTÁS", ConsoleColor.Magenta),
            Text("A szörnyektől és ládákból zsákmányolt Varázs ritkaságú fegyverek, páncélok, gyűrűk, amulettek, pálcák és tekercsek azonosítatlanul kerülnek elő. A fogadói portéka, a kezdőfelszerelés és az egyedi Legendás ereklye eleve ismert."),
            Text("❓ Azonosítás előtt csak a tárgy fajtája, súlya és az aurájának hozzávetőleges ereje ismerhető. A valódi név, mágikus hatás, töltet, alapár és leírás rejtve marad."),
            Text("⚠️ Azonosítatlan fegyver, páncél, gyűrű és amulett saját kockázatra felszerelhető és a hatása működik. Ismeretlen pálca vagy tekercs nem süthető el, mert a varázslata és célzása még nem ismert."),
            Blank(),
            Text("🧠 Frissen talált azonosítatlan tárgynál a parti legmagasabb effektív Intelligenciájú élő Mágusa automatikusan egyszer megkísérli az azonosítást. Esélye: 25% + Intelligencia × 5% − mágikus erő × 10%, legalább 5%, legfeljebb 95%. A próba eredménye megjelenik a zsákmányüzenetben; átadással vagy újrafelvétellel nem ismételhető."),
            Text("🧙 A fogadóban időnként megjelenő Vándormágus az egész parti felszerelt vagy hátizsákban tartott tárgyait garantáltan azonosítja. A díj: 20 arany + az alapár 8%-a + mágikus erőnként 15 arany."),
            Text("💰 Azonosítatlan mágikus tárgyat a kereskedő csak az alapár 25%-áért vesz meg. Az azonosítás végleges, a partival közös, és mentés után is megmarad."),
            Blank(),
            Text("☠️ A véletlen mágikus zsákmány átkozott is lehet: alapesélye 8%, az Elátkozott sírkamrákban 15%. A fogadói, kezdő-, küldetés- és egyedi Legendás felszerelés nem kap véletlen átkot."),
            Text("🔗 Az átok puszta felvételkor még nem hat. Fegyver, páncél, gyűrű, amulett, pálca vagy tekercs aktív felszerelésekor felébred, a karakterhez köti a tárgyat, amely ezután nem vehető le és nem adható át az átok megtöréséig."),
            Text("👁️ Azonosítás felfedi az átok nevét, erősségét és pontos hátrányát. Azonosítatlan felszerelésnél az aktiválódás és a kötődés láthatóvá válik, de a részletek továbbra is rejtve maradnak."),
            Blank(),
            Text("☠️ Lehetséges átkok: találat- vagy védelemcsökkenés, lomhaság, mozgási béklyó, természetellenes harci súly, magasabb mannaköltség, illetve Egészség- vagy Intelligenciacsökkenés. Több aktív átok hatása összeadódik."),
            Text("✝️ A papi Átoktörés a célpont ideiglenes káros mágikus hatásai mellett annak legerősebb aktív tárgyátkát is végleg megtöri. Egy varázslás egy tárgyat tisztít meg; a kötés feloldódik és a hátrány azonnal megszűnik."),
            Text("🧙 A Vándormágus bármely azonosított átkozott tárgyat garantáltan megtisztít, akkor is, ha az átok még nem aktiválódott. A díj: 50 arany + az alapár 12%-a + mágikus erőnként 25 arany + átokerősségenként 100 arany."),
            Blank(),
            Text("✨ A megtisztított tárgy megtartja eredeti mágikus tulajdonságait, többé nem aktiválódhat rajta az átok, és ismét szabadon levehető, átadható vagy eladható."),
            Blank(),
            Section("🛡️ ALAKZATOK", ConsoleColor.Cyan),
            Text("👥 Az alakzat legfeljebb négy élő, állandó csapattagot rendez 2×2-es rendbe. A helyek mindig a haladási irányhoz viszonyított ELSŐ BAL/JOBB és HÁTSÓ BAL/JOBB pozíciók."),
            Hotkey("KARAKTERLAP + A", "A vezér karakterlapjáról megnyitja az alakzatszerkesztőt. Coop játékban a vendégek a vezető döntésére várnak, amíg az ablak nyitva van."),
            Hotkey("SZERKESZTŐ: NYILAK", "Mozgás a négy alakzathely között."),
            ...
            Hotkey("ZÁRT: SHIFT+NYILAK", "Oldalazás vagy hátrálás az alakzat nézési irányának megtartásával."),
            Blank(),
            Text("🛡️ Zárt alakzatban csak a vezér mozgatja a csapatot. Falnak vagy foglalt mezőnek ütközve sem a helyzet, sem a nézési irány nem változik; a vendég nem léphet ki önállóan a rendből."),
            Text("🚪 Ajtóművelet zárt alakzatban bármelyik tag helyétől indítható. Harcban az élő első sor elölről védi a mögötte állót; oldalról és hátulról ez a védelem nem érvényes."),
            Text("🔱 Harcban a hátsó sor szálfegyverrel elérheti az elötte álló társ lekötött ellenfelét. Tárgyat csak szabad, le nem kötött hátsó sori karakter használhat; a HÁTRA! parancs az első és hátsó tagot cseréli meg."),
            Blank(),
            ColoredText("✨ VARÁZSHASZNÁLÓ PROFILOK", ConsoleColor.Magenta),
            Text("🤖 A profil az AI által irányított varázshasználó csapattag harci döntéseit szabályozza. A kézi irányítást és a vezér saját varázslását nem korlátozza."),
            Hotkey("SZERKESZTŐ: T", "A kijelölt Mágus, Pap vagy Lovag varázsprofiljának megnyitása."),
            Hotkey("PROFIL: ↑ / ↓", "A beállítás kijelölése."),
            Hotkey("PROFIL: ← / →, + / −", "A kijelölt érték módosítása; a mana elfogyásakor követett viselkedést a két lehetőség között váltja."),
            ...
            Text("⚔️ „Teljes támadás összereje” elérésétől a csatánkénti támadóvarázslat-korlát nem érvényes. A gyógyítás és a hasznos erősítések ettől külön, a harci helyzet és a rendelkezésre álló manna szerint működnek."),
            Blank(),
            ...
            Text("✝️ A Pap Halottűzése és a Lovag Szent elűzése 2 mezőre hat, átlósan is. Az első körtől elérhető; használat után 10 körrel újul meg, karakterenként külön. A hátsó sorból és alakzaton kívül is használható."),
            ...
            Text("⚙️ Alapértékek: Mágus 2 varázslat, 8/16-os küszöb, hátravonulás; Pap 1 varázslat, 15/30, önbuff+közelharc; Pap élőholt/démon profil 5 varázslat, 5/15; Lovag 0 varázslat, 20/40, önbuff+közelharc."),
            Blank(),
            ...
            Hotkey("T", "⚔️ TÁMADÁS: az NPC társak agresszívan keresik és megtámadják az ellenfeleket a parancs kikapcsolásáig."),
            ...
            Hotkey("B", "🚪 BETÖRÉS: a legerősebb élő partitag megpróbálja bezúzni a vezérhez legközelebbi, legfeljebb 4 mezőre levő kulcsra zárt ajtót."),
            Text("⚙️ A G / T / H módok kölcsönösen kizárják egymást. Az M kikapcsolja mindhármat; lejárta után a társak a saját kaszt- és személyiségalapú viselkedésükhöz térnek vissza."),
            Blank(),
            ...
            Blank(),
            Text("📜 A tekercs 0 mannás és egyszer használható (mágus: mágusige vagy papi ima; pap/lovag: papi ima). Azonos tekercsekből a varázstárgyhelyen 5, a hátizsákban 12 fér egy kötegbe."),
            ...
            Text("30           11     10      4"),
            Blank(),
            Section("☠️ ÁLLAPOTOK", ConsoleColor.DarkYellow),
            ...
            Text("✝️🛡️ Gonosz elleni védelem: +4 védelem, 30% csökkentés és állapotvédelem 5 körig."),
            Text("👼 Őrangyal: 5 körig kivédi az első halálos csapást és gyógyít; aktiváláskor elfogy."),
            Text("⛪ Szentély: 50% sebzéscsökkentés és állapotvédelem 4 körig; saját támadáskor megszűnik."),
            Blank(),
            ...
            Text("2. fokozat — 15. szint: Fegyvermester — +2 fegyveres találat és minden fegyverkopás −50% | Rendíthetetlen — minden elszenvedett találatból -2 sebzés."),
            ...
            ColoredText("Amikor először legalább 5 sebzést kap, 3 saját akcióra Dühbe kerül: támadásonként +5–10 sebzés, -2 védelem és teljes erejű többcélú söprés. Osztályjártasság: 5/10/15. szinttől +1/+2/+3 találat.", ConsoleColor.Yellow),
            ...
            ColoredText("Az első saját kör előtt választ: 🗡️ Orvtámadás — első találat ×2, tőrrel vagy jártas rövid karddal hátsó sorból is támad, hátba kerülve ismételhető | 👁️ Megfigyelés — +2 találat | ☠️ Mérgezett penge — találatonként +1–4 méregsebzés.", ConsoleColor.Yellow),
            ColoredText("🌟 10./20. szint: Halálos rajtaütés — Orvtámadás ×2,5 és bármely tolvajtaktikával hátsó sori tőr- vagy rövidkard-támadás | Gyenge pont — Megfigyelésnél a természetes 19 is kritikus | Erős méreg — +2–6 sebzés.", ConsoleColor.DarkCyan),
            Blank(),
            ...
            Blank(),
            Text("Az Orvtámadás taktika sebzésszorzója nem adódik össze az orvtámadás tehetség szorzójával. A Halálos rajtaütés mindkét módon aktivált orvtámadás szorzóját növeli."),
            Blank(),
            ...
            Text("🗡️ A Tolvaj Orvtámadás taktikája hátbatámadáskor minden alkalommal aktiválja az orvtámadás szorzóját. Zárt alakzat hátsó sorából tőrrel, valamint rövid karddal is elérheti az előtte álló társ lekötött ellenfelét. Rövid kardnál ehhez Orvtámadás és legalább Jártas kardfok, Halálos rajtaütés vagy Kardmester fok szükséges."),
            Blank(),
            ColoredText("✝️ PAP — ISTENI SZOLGÁLAT", ConsoleColor.White),
            ColoredText("Papi imákat használ, élőholt ellen 2 mezőre Halottűzést végezhet az első körtől, majd használat után 10 körrel újra. Az 1. tehetségfokozat megszerzésekor végleges specializációt is választ.", ConsoleColor.Cyan),
            ColoredText("💚 Élet: minden gyógyítás +25% | 🛡️ Védelem: a védőimák +1 körig tartanak | ⚖️ Ítélet: minden papi sebző varázslat +20%.", ConsoleColor.Green),
            ColoredText("🌟 10./20. szint: Túláradó élet — további +15% gyógyítás | Rendíthetetlen oltalom — védőimák +1 kör | Irgalmas ítélet — varázssebzés 10%-a gyógyít.", ConsoleColor.DarkCyan),
            Blank(),
            ...
            ColoredText("🔥 Elementalista: közvetlen arkán sebzés +20% | 🎭 Illuzionista: kontroll- és védőigék +1 körig tartanak | 💀 Nekromanta: a közvetlen varázssebzés 10%-a visszagyógyul.", ConsoleColor.Magenta),
            ColoredText("🌟 10./20. szint: Tomboló elemek — további +15% arkán sebzés | Tökéletes illúzió — kontroll/védelem +1 kör | Életaratás — sebzés 15%-a gyógyít.", ConsoleColor.DarkCyan),
            Blank(),
            ...
            Text("A 8. és a 18. karakterszinten egy-egy különböző taktikai diszciplína választható. A diszciplínák minden kaszt számára elérhetők, harcban működnek, és a fogadói veterán kiképzőnél átképezhetők."),
            Blank(),
            ...
            ColoredText("🏃 Portyázó — Harcban +2 kezdeményezést és +1 mező harci mozgást ad, legfeljebb 7 mezőig.", ConsoleColor.Green),
            ...
            Blank(),
            Text("🛡️ A mellékkézbe képesség nélkül csak pajzs tehető. A pajzs normál mellékkéz-támadást nem ad, de külön pajzslökéssel megingathat vagy hátralökhet. Tőr vagy kard csak aktív Kétfegyveres harccal és az összes érintett fegyvercsalád Jártas fokával szerelhető oda; más fegyver soha."),
            Blank(),
            ...
            Text("⚙️ Az átképzés mindig csak a kiválasztott csoportot érinti. A megszerzett lépések száma nem csökken, mindet azonnal újra kell osztani; ugyanaz a diszciplína vagy osztályképesség továbbra sem választható kétszer."),
            Text("💰 Az osztályképességek és diszciplínák díja legalább 300 arany, magasabb szinten szintenként 100 arany. A fegyverjártasság díja legalább 300 arany, magasabb szinten szintenként 75 arany."),
            Blank(),
            Section("⚔️ FEGYVERJÁRTASSÁGOK", ConsoleColor.Yellow),
            ...
            ColoredText("🧝 Elf tőr — 3–6 sebzésű ügyességi vágófegyver. Ha aktív kétfegyveres harcban mindkét kézben elf tőr van, mindkét penge +1 sebzést kap.", ConsoleColor.Green),
