...
public sealed class MainMenu
{
    ...
    public static void ShowHelp()
    {
        var source = new HelpSourceLine[]
        {
            ...
            Hotkey("ZÁRT: CTRL+← / →", "A teljes 2×2-es alakzat 90 fokos balra vagy jobbra fordítása, ha minden új hely szabad."),
            Text("Zárt alakzatban csak a vezér mozgatja a csapatot. A lépés és a fordulás csak akkor sikerül, ha minden célmező elfoglalható; a vendég nem léphet ki önállóan a rendből."),
