...
public sealed class MainMenu
{
    ...
    public static void ShowHelp(Func<string?>? coopStatusProvider = null)
    {
        var source = new HelpSourceLine[]
        {
            ...
            ColoredText("Az első saját kör előtt választ: 🗡️ Orvtámadás — első találat ×2, tőrrel hátsó sorból is támad, hátba kerülve ismételhető | 👁️ Megfigyelés — +2 találat | ☠️ Mérgezett penge — találatonként +1–4 méregsebzés.", ConsoleColor.Yellow),
            ColoredText("🌟 10./20. szint: Halálos rajtaütés — Orvtámadás ×2,5 és bármely tolvajtaktikával hátsó sori tőrtámadás | Gyenge pont — Megfigyelésnél a természetes 19 is kritikus | Erős méreg — +2–6 sebzés.", ConsoleColor.DarkCyan),
            Blank(),
