...
public sealed class MainMenu
{
    ...
    public static void ShowHelp()
    {
        var source = new HelpSourceLine[]
        {
            ...
            ColoredText("🗡️ Tőr — Jártas: +2 kezdeményezés, +1 sebzés | Mester: természetes 19–20 esetén ×2 kritikus; sikeres taktikai találat után kilép a lekötésből.", ConsoleColor.DarkYellow),
