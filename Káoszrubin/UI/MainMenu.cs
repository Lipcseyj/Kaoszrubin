...
public sealed class MainMenu
{
    ...
    public static void ShowHelp(Func<string?>? coopStatusProvider = null)
    {
        var source = new HelpSourceLine[]
        {
            ...
            Text("🚪 Ajtóművelet zárt alakzatban bármelyik tag helyétől indítható. Csapatharcban az élő első sor elölről védi a mögötte állót; oldalról és hátulról ez a védelem nem érvényes."),
            Text("🔱 Csapatharcban a hátsó sor szálfegyverrel elérheti az elötte álló társ lekötött ellenfelét. Tárgyat csak szabad, le nem kötött hátsó sori karakter használhat; a HÁTRA! parancs az első és hátsó tagot cseréli meg."),
            Blank(),
            ColoredText("✨ VARÁZSHASZNÁLÓ PROFILOK", ConsoleColor.Magenta),
            Text("🤖 A profil az AI által irányított varázshasználó csapattag csapatharcos döntéseit szabályozza. A kézi irányítást és a vezér saját varázslását nem korlátozza."),
