...
public sealed class MainMenu
{
    ...
    public static void ShowHelp()
    {
        var source = new HelpSourceLine[]
        {
            ...
            Hotkey("A", "A beállított 2x2-es alakzat összeállítása vagy feloszlatása."),
            Hotkey("CTRL+← / →", "A zárt alakzat 90 fokos fordítása."),
            ...
            Blank(),
            Section("TEHERBÍRÁS", ConsoleColor.Green),
            ...
            Text("A harci teherbírás a teljes teherbírás 75%-a. A harci terhelési fokozatot a harci súly ehhez a csökkentett értékhez viszonyítva adja a játék."),
            ...
            Text("Harci közepes terhelés: −1 kezdeményezés és −1 harci mozgás. Harci nehéz terhelés: −3 kezdeményezés és −2 harci mozgás. A karakterlapi ⚡ a dobás előtti kezdeményezési alapot mutatja."),
            ...
            Text("A fegyver sikeres használatkor 1, kritikus találatkor 2 pontot kopik. A fizikai találatot fogó páncél és pajzs ugyanennyit veszít. A sav ezeken felül 2, kritikusan 4 ponttal mar; a káosz egy véletlen felszerelést 1–3 ponttal, kritikusan kétszer ennyivel koptat."),
            Text("50% fölött a felszerelés ép. 26–50% között kopott, de még teljes erejű. 1–25% között sérült: a fegyver −1 találatot és −1 sebzést kap, a páncél és pajzs csak fél védelmet ad. 0-nál a fegyver használhatatlan, a vértezet nem véd."),
            ...
            Text("A fogadói Kovácsmester a fegyvereket és pajzsokat, a Páncélmíves a vértezeteket teljesen megjavítja. A díj a hiányzó tartósságtól és a ritkaságtól függ. A +1/+2/+3 fejlesztés +15/+30/+50% maximális tartósságot ad."),
            Text("A Fegyvermester minden fegyverkopást 1 ponttal, a Páncélmester minden páncél- és pajzskopást 1 ponttal csökkent, legalább nulláig."),
            Blank(),
            ...
            Text("Azonosítatlan fegyver, páncél, gyűrű és amulett saját kockázatra felszerelhető és a hatása működik. Ismeretlen pálca vagy tekercs nem süthető el, mert a varázslata és célzása még nem ismert."),
            ...
            Text("A véletlen mágikus zsákmány átkozott is lehet: alapesélye 8%, az Elátkozott sírkamrákban 15%. A fogadói, kezdő-, küldetés- és egyedi Legendás felszerelés nem kap véletlen átkot."),
            ...
            Text("Azonosítás felfedi az átok nevét, erősségét és pontos hátrányát. Azonosítatlan felszerelésnél az aktiválódás és a kötődés láthatóvá válik, de a részletek továbbra is rejtve maradnak."),
            Text("Lehetséges átkok: találat- vagy védelemcsökkenés, lomhaság, mozgási béklyó, természetellenes harci súly, magasabb mannaköltség, illetve Egészség- vagy Intelligenciacsökkenés. Több aktív átok hatása összeadódik."),
            Text("A papi Átoktörés a célpont ideiglenes káros mágikus hatásai mellett annak legerősebb aktív tárgyátkát is végleg megtöri. Egy varázslás egy tárgyat tisztít meg; a kötés feloldódik és a hátrány azonnal megszűnik."),
            ...
            Blank(),
            Section("ALAKZATOK", ConsoleColor.Cyan),
            ...
            Text("Zárt alakzatban csak a vezér mozgatja a csapatot. Falnak vagy foglalt mezőnek ütközve sem a helyzet, sem a nézési irány nem változik; a vendég nem léphet ki önállóan a rendből."),
            ...
            Blank(),
            Section("CSAPATHARC", ConsoleColor.Red),
            ...
            Hotkey("H", "HÁTRA!: az első sori karakter helyet cserél a mögötte álló élő társával."),
            Hotkey("P", "PASSZ: a karakter cselekvés nélkül befejezi a saját harci körét."),
            Hotkey("R", "A vezér visszavonulást rendel el; a lekötött társak búcsútámadást kapnak."),
            Text("Zárt alakzatban az élő első sor az alakzat eleje felől védi a mögötte álló társat. Oldalról és hátulról a hátsó sor továbbra is támadható."),
            ...
            Text("A sikeres visszavonuláshoz a leglassabb élő csapattagnak is gyorsabbnak kell lennie a leggyorsabb üldözőnél."),
            Blank(),
            ...
            Hotkey("T", "Pap/Lovag: Halottűzés / Szent elűzés 2 mezőre, az első körtől, használat után 10 körrel újra."),
            ...
            Text("2. fokozat — 15. szint: Fegyvermester — +2 fegyveres találat és minden fegyverkopás −1 | Rendíthetetlen — minden elszenvedett találatból -2 sebzés."),
            ...
            Text("2. fokozat — 15. szint: Páncélmester — a páncéldobás legalább az átlag és minden páncél-/pajzskopás −1 | Szent eskü — csatakezdéskor +10 HP."),
            ...
            Text("Az átképzés mindig csak a kiválasztott csoportot érinti. A megszerzett lépések száma nem csökken, mindet azonnal újra kell osztani; ugyanaz a diszciplína vagy osztályképesség továbbra sem választható kétszer."),
