...
public sealed class MainMenu
{
    ...
    public static void ShowHelp(Func<string?>? coopStatusProvider = null)
    {
        var source = new HelpSourceLine[]
        {
            ...
            Hotkey("SPACE", "⚔️ A kijelölt, szomszédos ellenfél megtámadása."),
            ...
            Text("⚖️ Teljes teherbírás = 5 + max(6, Erő × 4) + Egészség + egész(Ügyesség / 3). Ez a teljes hordott súly viszonyszáma."),
            ...
            Text("⚔️ A Harcos, Barbár és Lovag karakteralkotáskor, majd a 7., 17. és 27. szinten kap egy jártassági lépést. A Tolvaj, Pap és Mágus a 7. és 17. szinten kap lépést."),
