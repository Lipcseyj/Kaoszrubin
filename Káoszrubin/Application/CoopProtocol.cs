...
public static class CoopProtocolJson
{
    ...
    public static string Encode(object message)
    {
        ...
        var (type, payloadType) = message switch
        {
            ...
            SetPlayerWindowVisibilityCommand => ("command.player-window-visibility", typeof(SetPlayerWindowVisibilityCommand)),
            ChangeCharacterColorCommand => ("command.character-color", typeof(ChangeCharacterColorCommand)),
            ...
            SplitInventoryStackCommand => ("command.inventory-split", typeof(SplitInventoryStackCommand)),
            DistributeInventoryStackCommand => ("command.inventory-distribute", typeof(DistributeInventoryStackCommand)),
            GiveFollowerStackCommand => ("command.inventory-give-follower", typeof(GiveFollowerStackCommand)),
            ...
            InnSaleCommand => ("command.inn-sale", typeof(InnSaleCommand)),
            AcknowledgeNarrativeCommand => ("command.narrative-ack", typeof(AcknowledgeNarrativeCommand)),
            AcknowledgeLevelImageCommand => ("command.level-image-ack", typeof(AcknowledgeLevelImageCommand)),
            AcknowledgeRestCommand => ("command.rest-ack", typeof(AcknowledgeRestCommand)),
            AcknowledgeSharedWindowCommand => ("command.shared-window-ack", typeof(AcknowledgeSharedWindowCommand)),
    ...
    public static object Decode(string json)
    {
        ...
        return envelope.Type switch
        {
            ...
            "command.player-window-visibility" => Deserialize<SetPlayerWindowVisibilityCommand>(envelope),
            "command.character-color" => Deserialize<ChangeCharacterColorCommand>(envelope),
            ...
            "command.inventory-split" => Deserialize<SplitInventoryStackCommand>(envelope),
            "command.inventory-distribute" => Deserialize<DistributeInventoryStackCommand>(envelope),
            "command.inventory-give-follower" => Deserialize<GiveFollowerStackCommand>(envelope),
            ...
            "command.inn-sale" => Deserialize<InnSaleCommand>(envelope),
            "command.narrative-ack" => Deserialize<AcknowledgeNarrativeCommand>(envelope),
            "command.level-image-ack" => Deserialize<AcknowledgeLevelImageCommand>(envelope),
            "command.rest-ack" => Deserialize<AcknowledgeRestCommand>(envelope),
            "command.shared-window-ack" => Deserialize<AcknowledgeSharedWindowCommand>(envelope),
