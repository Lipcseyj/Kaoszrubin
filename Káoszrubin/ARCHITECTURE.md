...
A páncélok a súly után, a szörnyek az alvásjelző és FegyverId után VágásVédelem, SzúrásVédelem, ZúzásVédelem oszlopokat kapnak. Ezek előjeles páncélmódosítók: a pozitív érték erősít, a negatív gyengeséget jelent. A módosító a megfelelő sebzéstípus ellen a páncélhoz adódik, minimum nulláig, a meglévő páncéltörési és sebzéscsökkentési szabályok előtt. A harci részletező feltünteti a típust és a módosítót.

Minden betöltött szörnynek konkrét, ellenőrzött FegyverId-je van. Sebzése a fegyver tartományából dobódik, ehhez az erőbónusz és a meglévő szörnyképességek adódnak. A természetes fegyverek NATURAL családúak, nem viselhetők, nem kereskedhetők és nem kapnak generált mágikus változatot. A goblin és ork fegyverváltozatok AlapSzörnyId-je biztosítja a közös küldetésbeszámítást, portrét és zsákmányt. A pályagenerálás az alapfaj találkozásainál a fegyverváltozatok közül is választ; a mentés a kiválasztott változat azonosítóját őrzi.
