...
public sealed class MainMenu
{
    ...
    public static void ShowHelp()
    {
        var source = new HelpSourceLine[]
        {
            ...
            Hotkey("H", "MEGÁLLJ: minden NPC társ azonnal tartja a helyét; újbóli H kikapcsolja."),
            Hotkey("G", "GYÜLEKEZŐ: az NPC társak harckeresés nélkül a leader mellé zárkóznak és ott maradnak."),
            Hotkey("T", "TÁMADÁS: minden NPC társ agresszív lesz a parancs kikapcsolásáig."),
            Hotkey("M", "10 másodperces szétszóródás; kikapcsolja a többi partiparancsot."),
