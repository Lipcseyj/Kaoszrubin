...
- A `Game.CreateSessionSnapshot()` a futó host állapotából elkészíti a transport által közvetlenül publikálható session- és world read modelt. Host módban a fő ciklus csak akkor és legfeljebb 10 Hz-cel készít snapshotot, ha van csatlakozott vendég. A world projekció csak a `FogOfWar` szerint ténylegesen felfedett adatokat adja át. A publisher a hostnak minden party-inventoryt átad, a vendég frame-jében viszont csak a hozzá rendelt karakter inventoryja marad. A helyi inventory UI mozgatáskor, használatkor és eldobáskor sem módosít közvetlenül állapotot: szemantikus commandot küld, amelyet a host dolgoz fel. A vendégképernyő a hálózati read modelből rajzol térképet és party-státuszt, mozgási és egyszerű harci commandot küld. A szimulációs szálon elutasított commandok címzetten visszajutnak hozzá. A session vezérlési állapota és a party-lista többszálú olvasás ellen védett. A következő nagy rés a távoli karakter saját találkozásának és csatájának host-oldali állapotgépe.
