...
- A `Game.CreateSessionSnapshot()` a futó host állapotából elkészíti a transport által közvetlenül publikálható read modelt. Az első protokollverzió még nem tartalmaz pályatopológiai, ajtó-, loot- és teljes inventory-adatokat; ezek külön world snapshot/delta szerződésként következnek, hogy ne a mentési formátum váljon hálózati API-vá.
